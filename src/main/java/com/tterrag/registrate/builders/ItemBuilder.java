...
public class ItemBuilder<T extends Item, P> {
    ...
    public ItemBuilder(CreateRegistrate owner, String name, NonNullFunction<Item.Properties, T> factory) {
        this(owner, name, factory, null);
    }

    public ItemBuilder(CreateRegistrate owner, String name, NonNullFunction<Item.Properties, T> factory, P parent) {
        this.owner = owner;
        this.name = name;
    ...
    public ItemBuilder<T, P> tag(TagKey<Item> tag) {
        return this;
    }
    ...
    public ItemEntry<T> register() {
        ...
        ItemEntry<T> entry = new ItemEntry<>(name, item);
        owner.trackItem(entry);
        return entry;
    }
}
